...
34 of 35 batch-A execs have a headshot in the `politician_photos` bucket + `essentials.politician_images.url`. IN's Morales/Elliott (642977/688298) already had images (pre-existing) — confirmed present, not re-inserted.
