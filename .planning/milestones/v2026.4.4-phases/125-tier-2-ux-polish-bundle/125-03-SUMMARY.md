...
### Task 3: Production verification — COMPLETE

G-114-020: PASSED — readrank.empowered.vote tab reads "Read & Rank — Empowered Vote"
G-114-021: PASSED — "Near you" section shows Indiana municipalities after Essentials address search (approach revised — see Deviations)
G-114-023: PASSED — Monroe County shows FY banner; Bloomington correctly does not
G-114-024: PASSED — Bloomington YearSelector contains 2025
...
| treasury-tracker | 367d7c5 | feat(125): geo-default Treasury landing from evUserAddress cookie |
| treasury-tracker | e3d7b56 | feat(125): show address in Near you section header |

All pushed to remote `main` (Render auto-deploys triggered).
