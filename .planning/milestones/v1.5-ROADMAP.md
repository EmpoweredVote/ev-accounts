...
- [x] **Phase 30: Fix Compass Calibration Layout & Write-in** - 50/50 chart/stances split, question text above stances, write-in drag-and-drop in CalibrationOverlay (completed 2026-02-23)
- [x] **Phase 31: Essentials Profile & District Data Fixes** - Chamber/district subtitles, initials avatars, labeled term dates, Bloomington district boundaries imported (completed 2026-02-23)
...
**Plans**: 2 plans
Plans:
- [x] 30-01-PLAN.md — Layout restructure: 50/50 split, question text above stances, chart vertical centering
- [x] 30-02-PLAN.md — Write-in integration: dnd-kit drag-and-drop, stance positioning, topic-change restoration
...
**Plans**: 3 plans
Plans:
- [x] 31-01-PLAN.md — Backend: add district_id to API responses + X0001 MTFCC mapping
- [x] 31-02-PLAN.md — ev-ui: profile subtitle, term labels, initials avatar, card subtitle prop; publish v0.1.27
- [x] 31-03-PLAN.md — Essentials: wire subtitle to cards, remove Issues section from profile, import Bloomington district boundaries
