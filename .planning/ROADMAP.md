...
- [x] Phase 15: Compass Admin React UI (5/5 plans) — completed 2026-03-07
  - [x] 15-01-PLAN.md — Navigation scaffold: routes, sidebar links, three stub pages
  - [x] 15-02-PLAN.md — Topics page: list, live toggle, create modal, stance editor panel (CADM-08, CADM-09)
...
- [ ] 15-05-PLAN.md — GAP: GET /admin/compass/topics/:id/stances — missing backend endpoint blocks stance editor and politician RadioGroup
