...
three city governments, not four. Only **stage 5, assets, remains open for Florida**: 72 people,
0 headshots, and three banners plus Palm Beach's own county key.
...
Beach has **no city half**, so it is a county row with no municipal partner. **72 people across the
seven local/county jurisdictions, 0 headshots: that is the whole of Florida's stage-5 debt.**
