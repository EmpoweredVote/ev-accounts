...
- [ ] **ONBOARD-01**: Topic/issue cards display correctly across all compass views (Library, CalibrationOverlay pick step, Quiz) — regression from recent changes fixed
