...
- [x] **VERD-06**: Essentials reads and caches guest verdicts from URL fragment to localStorage

### Profile Integration

- [x] **PROF-01**: CompassContext extended with verdicts state field (priority: API > fragment > localStorage)
