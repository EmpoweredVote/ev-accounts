...
- [x] **ELEC-02**: Races grouped by government tier (Local > State > Federal) then by specific position (e.g., "State Representative, District 60")
- [x] **ELEC-03**: Each race section shows all candidates with name, photo, and position sought
- [x] **ELEC-04**: Incumbent candidates visually distinguished with badge/indicator
- [x] **ELEC-05**: Election date and type (Primary/General/Retention) displayed per race with days-until countdown when <60 days
- [x] **ELEC-06**: User navigates to Election Central from the same address search as the representatives page
- [x] **ELEC-07**: Empty state shown clearly when no upcoming election data exists for the searched address
