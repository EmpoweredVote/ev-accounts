...
console.log('  🔴 Task 4 is NOT emitted yet.');
console.log('  🔴 Both files are CC_wip_ on purpose — take the numbers LAST, re-counted across every remote ref.');
console.log('  ⚠ The occupancy half cannot be dry-run alone. Run both as ONE transaction ending in ROLLBACK.');
