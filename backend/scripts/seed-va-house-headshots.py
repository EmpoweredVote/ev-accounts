...
BANDS = {
    'VA': (-511199, -510101, 'Virginia', '2026 Virginia General Election'),
}
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_va-house-headshot-results.json')
...
def main():
    ...
    if state not in BANDS:
        print('ERROR: --state VA required (or --manual <file>)'); sys.exit(1)
