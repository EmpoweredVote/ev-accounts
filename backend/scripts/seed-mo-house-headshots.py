"""
seed-mo-house-headshots.py — Phase 162-02 (v2.22 Wave 3). CLONE of seed-tn-house-headshots.py, all
guards intact incl. Phase-156 hardening (dropped 'american' kw + pre-1940 historical-year reject).
Only changes: MO band, MO state name, RESULTS_JSON, and the localized ", missouri" place-token in
...
_NON_PERSON_TITLE = _re.compile(
    r'(election|congressional district|gubernatorial|ballot|primary|\bcity\b|, missouri|'
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_mo-house-headshot-results.json')
