#!/usr/bin/env node
/**
 * Dry-run migration 1564: execute it for real inside a transaction that is ALWAYS rolled back.
 *
...
const sqlRaw = readFileSync(path.join(HERE, '..', 'migrations', '1564_retire_fabricated_source_stances.sql'), 'utf8');
