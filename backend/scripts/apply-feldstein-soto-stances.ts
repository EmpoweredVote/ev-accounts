...
// New format: value column is already 1-5 (DB scale). No conversion needed.
const pool = new pg.Pool({ connectionString: process.env.DATABASE_URL, ssl: { rejectUnauthorized: false } });
const csv = readFileSync('data/stance-research/2026-05-07-hydee-feldstein-soto.csv', 'utf8');
