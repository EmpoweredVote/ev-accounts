...
Only changes: WI band, WI state name, RESULTS_JSON, and the localized ", wisconsin" place-token in
...
Writes backend/scripts/_wi-house-headshot-results.json.
"""
...
# WI band: -550899..-550101 (163-02 generator output, actual range -550803..-550101; excludes
# incumbents -55001..-55008 which fall far outside this band). Election name is NOT used for scoping.
BANDS = {
    'WI': (-550899, -550101, 'Wisconsin'),
}
...
_NON_PERSON_TITLE = _re.compile(
    r'(election|congressional district|gubernatorial|ballot|primary|\bcity\b|, wisconsin|'
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_wi-house-headshot-results.json')
