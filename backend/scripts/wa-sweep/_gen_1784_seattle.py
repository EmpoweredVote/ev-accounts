# Generates 1784_seattle_council_web_sources.sql.
# Rows are built from a data table so politician/topic UUIDs are never transcribed by hand.
# Reasoning is dollar-quoted ($r$...$r$) so apostrophes need no escaping.
import io, os

P = {
    'wilson':        ('90d1ac0b-efa6-42fc-abb2-34767380d607', 'Katie Wilson'),
    'evans':         ('1018a81d-652c-46bb-9e18-3adf91d1f474', 'Erika Evans'),
    'saka':          ('215f2142-c0a1-46fb-b78e-3204843ae3e5', 'Rob Saka'),
    'lin':           ('9e33c647-967a-4dce-a900-ad7d066cc57f', 'Eddie Lin'),
    'hollingsworth': ('1187a22d-1064-4ff4-8193-189c34b4b6e8', 'Joy Hollingsworth'),
    'rivera':        ('81057c65-d128-4712-8ded-52c4534b0d9b', 'Maritza Rivera'),
    'juarez':        ('b510823d-e54b-40a5-92c0-09a6636359d5', 'Debora Juarez'),
    'strauss':       ('2e4714c6-feb4-443f-9cc0-08d866a0a99f', 'Dan Strauss'),
    'kettle':        ('8c15f6a8-2c28-4b34-a736-ca4d6340f615', 'Robert Kettle'),
    'rinck':         ('5c98f25c-4d32-450c-8428-4e3647cbde4d', 'Alexis Mercedes Rinck'),
    'foster':        ('675e3f43-73e9-4de8-b514-d63b146a8fc7', 'Dionne Foster'),
}
T = {
...
U25 = 'https://www.theurbanist.org/content/files/www-theurbanist-org/wp-content/uploads/2025/07/'
U03 = 'https://www.theurbanist.org/content/files/www-theurbanist-org/wp-content/uploads/2025/03/'
U23 = 'https://www.theurbanist.org/content/files/old-theurbanist-org/wp-content/uploads/2023/07/'
Q = {
    'wilson':        U25 + 'katie-wilson-2025-urbanist-questionnaire-responses-for-publication.pdf',
    'evans':         U25 + 'erika-evans-urbanist-questionnaire-responses-for-publication.pdf',
    'lin':           U25 + 'eddie-lin-urbanist-questionnaire-responses-for-publication.pdf',
    'foster':        U25 + 'dionne-foster-urbanist-questionnaire-responses-for-publication.pdf',
    'rinck':         U03 + 'early-endorsement-questionnaire-for-scc-alexis-mercedes-rinck-1.pdf',
    'saka':          U23 + 'rob-saka-urbanist-questionnaire-2023.pdf',
    'hollingsworth': U23 + 'joy-hollingsworth-urbanist-questionnaire-2023.pdf',
    'rivera':        U23 + 'maritza-rivera-urbanist-questionnaire-2023.pdf',
    'strauss':       U23 + 'dan-strauss-urbanist-questionnaire-2023-1.pdf',
}
COMP = 'https://www.theurbanist.org/2025/09/20/seattle-council-punts-on-housing-expansion-passes-strict-tree-preservation-rules/'
KETQ = 'https://publicola.com/2023/10/24/publicola-questions-city-council-candidate-bob-kettle-district-7/'
KETT = 'https://www.theurbanist.org/kettle-proposes-slashing-seattle-transit-measure-halting-city-funded-bus-service-growth/'
JUAR = 'https://www.theurbanist.org/seattle-council-poised-to-appoint-debora-juarez-to-vacant-d5-seat/'

# (person, topic, value, reasoning, [sources])  -- value None means a DOCUMENTED BLANK
R = [
# ── Katie Wilson, Mayor ──────────────────────────────────────────────────────────────────────────
('wilson','taxes',1,
 'Asked which progressive revenue sources she would add to fund her priorities, Wilson answered "Yes" and listed a capital gains tax ("we should have done that last year"), "turn[ing] the dials" on the JumpStart payroll expense tax to raise more, restructuring the B&O tax, a land value tax, and a professional services excise tax, a digital ad tax and a vacancy tax from the Progressive Tax Options for Seattle report she co-authored. Her stated priorities are affordable and abundant housing and a real reduction in homelessness, so the destination is new investment rather than backfilling existing services. That is chair 1 rather than chair 2, which funds existing services.',
 [Q['wilson']]),
('wilson','housing',1,
 'Wilson answers the housing question with "Build social housing!" alongside support for community land trusts, and separately proposes "granting social housing the same density bonus that other types of affordable housing get". Seattle social housing is publicly owned in perpetuity by the Social Housing Developer and available across a broad income range, which is chair 1 rather than chair 3 targeted assistance. Chair 2 is refuted from her own answer: she would "exempt smaller projects from MHA fees so they will pencil out", the opposite of requiring new development to include affordable units.',
 [Q['wilson']]),
('wilson','residential-zoning',4,
 'Wilson would "Zone for more housing in neighborhoods throughout Seattle" and "Reform permitting, design review, and other bureaucratic hurdles that make it so expensive and difficult to build right now", and on the comprehensive plan calls for "adding more neighborhood growth centers, expanding the definition of near transit" and "eliminating parking minimums". Broad upzoning, streamlined approvals and reduced parking are chair 4 verbatim. Chair 5 is not reached: she works through growth centers and transit proximity and nowhere proposes allowing any housing type on any lot citywide.',
 [Q['wilson']]),
('wilson','transportation-priorities',1,
 'Wilson would prioritise "transforming our most dangerous corridors, from Aurora to Rainier, into people-centered streets with great public transit", and "Maximize efficient use of Keep Seattle Moving Levy dollars to build new sidewalks, improve transit infrastructure, and connect our bike network", together with eliminating parking minimums. Pedestrian infrastructure, cycling networks, transit and reduced parking are chair 1 in full. Chair 2 is refuted because she does not propose investing equally in roads.',
 [Q['wilson']]),
('wilson','public-safety-approach',2,
 'Wilson would "Expand alternative crisis response and civilian roles, so police can focus on policing", specifically by creating "a better dispatch protocol so that the CARE team can respond to crisis calls independently when safe and appropriate" and "civilianizing ancillary work, from directing traffic at events to taking down crime reports". She proposes neither an increase nor a reduction in sworn staffing anywhere in the answer, which is what separates chair 2 from chair 4 and from chair 1. The mechanism she names is shifting call types away from armed officers, which is chair 2 rather than chair 3.',
 [Q['wilson']]),
('wilson','homelessness-response',2,
...
# ── Eddie Lin, D2 ────────────────────────────────────────────────────────────────────────────────
('lin','taxes',1,
 'Lin answers that he "absolutely support[s] new progressive revenues", would "defend (and potentially increase) the Jump Start Payroll Tax", would "support a local Capital Gains Tax and open to considering other taxes, like a vacancy tax", and supports a state Wealth Tax, calling the regressive state tax system "immoral and bad public policy". His priorities are lowering housing costs, getting people off the streets into shelter and treatment, and gun violence prevention, so the revenue funds new investment. That is chair 1 rather than chair 2.',
 [Q['lin']]),
('lin','residential-zoning',4,
 'Lin would "reduce housing production barriers like design review, parking requirements, and overly restrictive limits around height, setbacks, floor area ratios (FARs) and lot coverage", would "eliminate parking requirements for housing developments", and says "We really should be allowing dense, walkable neighborhoods everywhere, and not just concentrating growth on arterials or in little pockets", pushing "to maximize density and growth as much as allowed". Broad upzoning, streamlined approvals and reduced parking are chair 4. Chair 5 is not reached: he never calls for eliminating single-family-only zoning or allowing any housing type on any lot.',
 [Q['lin']]),
('lin','transportation-priorities',1,
 'Lin would convert dangerous two-lane arterials to one lane each way, and calls for "protected bike lanes, more sidewalks, and raised crosswalks", the new Shared Streets law "to put pedestrians first", piloting car-free zones, congestion pricing, and eliminating parking requirements. Prioritising pedestrian infrastructure, cycling networks and transit while reducing parking is chair 1 in full.',
 [Q['lin']]),
('lin','homelessness-response',2,
 'Lin would "increase shelters and tiny home villages, by permitting more of them throughout the City, including on public property, and funding them, especially funding supportive services", and calls for "more Housing First options, with robust supportive services". Expanding shelter capacity and services as the primary strategy is chair 2. Chair 1 is not reached because his lead mechanism is shelter and tiny homes rather than permanent supportive housing with no preconditions, and chairs 4 and 5 are refuted because he proposes no enforcement tool at all.',
 [Q['lin']]),
('lin','public-safety-approach',2,
 'Lin calls for "better 911 responses, with more social workers and mental health specialists for situations that do not require an officer", and would "negotiate a SPOG contract without limits on the number of CARES or Health One responders", reasoning that this "will allow police the capacity to respond to dangerous crimes". Shifting the calls that do not need an armed officer to unarmed responders, without proposing a change to sworn staffing, is chair 2. Chair 3 is not reached: his mechanism is reallocating call types rather than adding teams on top of current funding.',
 [Q['lin']]),
('lin','growth-and-development',4,
 'Lin says the comprehensive plan "should allow for much more growth!!!" and blames underpredicted growth in the last plan for the housing cost and homelessness crisis. He would "streamline the permitting process, both in terms of timelines and substantive requirements", provide "more tax exemptions for housing production", and hold MHA payments on middle housing to at most a de minimis amount. He also states chair 4 rationale explicitly: incentivizing housing production "brings in revenues through sales taxes, REETA, and increased property taxes". Streamlined permitting, reduced fees and a tax-base rationale are the three limbs of chair 4.',
 [Q['lin']]),
('lin','housing',4,
 'Lin\'s housing answer is a deregulatory supply programme: "We need a bold Comprehensive Plan and to reduce housing production barriers like design review, parking requirements, and overly restrictive limits around height, setbacks, floor area ratios (FARs) and lot coverage. We can streamline the permitting process". Cutting regulations and zoning rules so private developers can build more is chair 4. Chair 2 is refuted from his own words: he does "not support applying MHA to middle housing in formerly single-family zones", so he rejects requiring new development to include affordable units.',
 [Q['lin']]),
# ── Dionne Foster, Position 9 ────────────────────────────────────────────────────────────────────
('foster','housing',2,
 'Foster holds all three of chair 2\'s limbs. She would "Support statewide rent stabilization and tenant protections" (rent caps); on MHA she warns that "Allowing duplexes, triplexes, and other middle housing types without any affordability requirements risks missing an opportunity" and wants its benefits "shared equitably across the city" (requiring new development to include affordable units); and she would "Protect dedicated affordable housing funds" and invest in subsidised housing (publicly funding new housing). Chair 3 is the weaker fit because her programme is not limited to targeted assistance.',
 [Q['foster']]),
('foster','rent-regulation',2,
 'Foster would "Support statewide rent stabilization and tenant protections to ensure a level playing field and provide safe, affordable housing for all renters in Seattle." Washington enacted statewide rent stabilisation in EHB 1217 in 2025, so supporting and extending it is chair 2, strengthening existing rent stabilization and extending coverage. This follows the ruling already made on EHB 1217 in the Washington legislative sweep, where chair 2 was chosen over chair 3 because "maintain current tenant protections" is the more serious mismatch for a first-ever statewide cap.',
 [Q['foster']]),
('foster','taxes',2,
 'Foster supports progressive revenue, but her stated destination is preservation rather than expansion: "The Trump administration and its massive budget cuts threaten our city. We need to get real about this threat and get serious about local progressive revenue," starting from the Revenue Stabilization Workgroup report with "a local capital gains tax or exploring partnership with the state for a mansion tax", and she would "work to protect our budgets from harmful federal overreach". Revenue raised to hold existing services against federal cuts is chair 2, not chair 1. This is the destination test that has governed this ladder since migration 1759.',
 [Q['foster']]),
('foster','residential-zoning',4,
 'Foster would add "another group of centers" beyond the Mayor\'s plan and would "look at other areas where we can add additional density, flexibility, or options for housing including expanding corridor upzones, areas around transit facilities, along Highway 99 and other underutilized areas", concluding that "The neighborhood center approach has its limitations; the fundamental goal is housing abundance." Chair 3 is refuted by its second clause, since she does not protect most residential zones. Chair 4\'s main clause, broad upzoning, is positively evidenced; its by-right and parking limbs are unstated, which is incompleteness rather than contradiction.',
 [Q['foster']]),
('foster','transportation-priorities',1,
 'Foster would "frontload sidewalk construction in historically under resourced neighborhoods", target Vision Zero projects, build transit-ready infrastructure "continuing to make it easier to get around Seattle without a car", and deliver bike infrastructure; on street space she writes that "Reclaiming street space from car storage and car lanes creates room for more efficient, equitable, and sustainable uses--like dedicated bus lanes, protected bike lanes, wider sidewalks". Her mention of bridges and roadways is maintenance, not investment parity, so this is chair 1 rather than chair 2.',
 [Q['foster']]),
('foster','public-safety-approach',3,
 'Foster would "Advocate for smart workforce development policies that attract and retain the officers we need" and "Support continued investment in the city\'s CARE Team, gun violence prevention programs, and community-driven solutions", alongside treatment on demand and behavioral health investment. Retaining current staffing while adding and sustaining crisis response capacity is chair 3. Chair 4 is not reached because she nowhere proposes increasing the force, and chair 2 is not reached because she does not propose shifting call types away from officers.',
 [Q['foster']]),
('foster','homelessness-response',2,
 'Foster would "Prioritize getting people indoors by working with regional agencies to invest in treatment on demand, permanent supportive housing, and emergency shelter solutions - including tiny homes." Expanding shelter and services as the primary strategy is chair 2. Chair 1 is not reached because permanent supportive housing is one item in a list led by getting people indoors through shelter, and she states no position against enforcement, which chair 1 requires.',
 [Q['foster']]),
# ── Alexis Mercedes Rinck, Position 8 ────────────────────────────────────────────────────────────
('rinck','housing',1,
 'Rinck writes that "As a proud supporter of Prop 1A I believe social housing represents a vital tool", that it "provides a financially sustainable solution, ensuring stable and affordable homes for a broad range of incomes", and that "With Prop 1A passing decisively, I have already begun to work with the Seattle Social Housing Developer to expedite bringing new housing online." Publicly owned housing available across incomes rather than means-tested is chair 1, and she is acting on it in office rather than only endorsing it.',
 [Q['rinck']]),
('rinck','residential-zoning',4,
 'Rinck would "Push for removing and/or reducing where possible all minimum parking requirements for residential and commercial spaces", "Allow more homes near transit... Specifically allowing 1/2 mile around bus stops, and 1/2 mile around light rail stations", "Align Seattle\'s middle housing standards with the Department of Commerce model ordinance", create FAR bonuses for fourplexes and six-plexes, and allow corner stores on all lots. Broad upzoning, streamlined standards and reduced parking are chair 4. Her 2025 comprehensive plan work corroborates it: she proposed restoring eight neighbourhood growth centres and pressed parking reform and ADU incentives.',
 [Q['rinck'], COMP]),
('rinck','transportation-priorities',1,
 'Rinck writes that "As a transit rider who chooses not to own a car" her focus "is on building an integrated network that prioritizes walking, biking, rolling, and public transit", including "expanding public transit, electrifying our transportation infrastructure, adding sidewalks, creating safer bike routes, and improving accessible pedestrian signals", and separately would remove all minimum parking requirements where possible. Prioritising pedestrian infrastructure, cycling networks and transit while reducing parking is chair 1 in full.',
 [Q['rinck'], COMP]),
('rinck','taxes',1,
 'Rinck names as a top priority "Enacting new progressive revenue options... and invest further into our city services to ensure Seattle can truly be a city that works for everyone", and in office authored and passed an amendment to Seattle\'s state legislative priorities "to increase funding for affordable housing" and another "to support new statewide progressive revenue options". The authored amendment increases funding rather than preserving it, which is what places her at chair 1 rather than chair 2. Note she also states a preservation purpose (preventing cuts to essential services); the increase is the discriminator and this is the row to revisit if that reading is rejected.',
 [Q['rinck']]),
# ── Erika Evans, City Attorney ───────────────────────────────────────────────────────────────────
('evans','homelessness',2,
 'Asked directly "Do you support camping bans or sweeps?", Evans answers "Absolutely not. Sweeping our unhoused neighbors... is cruel, ineffective, and unethical." She would "strongly support legislation or filing amicus briefs opposing the U.S. Supreme Court\'s decision in City of Grants Pass v. Johnson, which overturned Martin v. Boise and opened the door for cities to criminalize homelessness", and concludes "We should invest in housing and services, not push people further into crisis." Decriminalising public sleeping while investing in shelter and services is chair 2. Chair 1\'s second limb, redirecting enforcement budgets, is unstated.',
 [Q['evans']]),
('evans','judicial-criminal-justice',2,
 'Evans names "Restorative Justice" as her second stated priority and would bring "back a better version of Community Court--one that connects people to housing and services while still ensuring accountability", moving "from reactive prosecution to proactive justice... to address root causes of crime". A community court connecting people to treatment and services is chair 2, giving the person a fair chance to make things right. Because the purpose is STATED rather than inferred, the stated purpose governs over the structural reading of chair 3, following the boundary set in migration 1780.',
 [Q['evans']]),
('evans','judicial-prosecution-priorities',3,
 'Evans would "Clear the backlog. Prosecute wage theft, DUI, domestic violence, and assault cases swiftly", ensure "property crimes that hurt small businesses are taken seriously", and simultaneously "Rebuild Community Court to address root causes". Prosecuting strong cases while using diversion where it clearly benefits is chair 3. Chair 2 is refuted by her own commitments: she does not reserve prosecution for when community safety requires it but pledges to prosecute more of the backlog faster.',
 [Q['evans']]),
('evans','taxes',1,
 'Evans notes that "The City Attorney doesn\'t set tax policy" and then states her position anyway: "I strongly support fixing Washington\'s regressive tax code. We need bold, progressive revenue sources--like taxing extreme wealth and excess corporate profits--to fund housing, public safety, and community services." Taxing wealth and large corporations to fund services is chair 1; the adverb "bold" and the expansion of the services named place it above chair 2.',
 [Q['evans']]),
# ── Rob Saka, D1 ─────────────────────────────────────────────────────────────────────────────────
('saka','residential-zoning',3,
...
w("""-- 1784_seattle_council_web_sources.sql
-- Seattle's 11 city offices, re-researched from WEB sources. %d seated rows + %d documented blanks.
--
...
vals = []
for who, tk, val, _reason, _src in R:
    pid, nm = P[who]
...
ctx = []
for who, tk, _val, reason, src in R:
    pid, _nm = P[who]
...
ans = []
for who, tk, val, _reason, _src in seats:
    pid, _nm = P[who]
...
BEGIN
  ...
  RAISE NOTICE 'Seattle: %d seated rows + %d documented blanks across 11 of 11 city offices; ORPHAN_CONTEXT still 50';
END $$;
...
dest = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..',
                    'migrations', '1784_seattle_council_web_sources.sql')
