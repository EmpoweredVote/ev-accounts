...
Only changes: WI band, WI state name, RESULTS_JSON, and the localized ", south carolina" place-token in
...
Writes backend/scripts/_sc-house-headshot-results.json.
"""
...
# SC band: -450799..-450101 (163-05 generator output, actual range -450701..-450101; excludes
# incumbents -45001..-45007 which fall far outside this band). Election name is NOT used for scoping.
BANDS = {
    'SC': (-450799, -450101, 'South Carolina'),
}
...
_NON_PERSON_TITLE = _re.compile(
    r'(election|congressional district|gubernatorial|ballot|primary|\bcity\b|, south carolina|'
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_sc-house-headshot-results.json')
