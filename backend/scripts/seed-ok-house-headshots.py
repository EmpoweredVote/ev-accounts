"""
seed-ok-house-headshots.py — Phase 164-05 (v2.22 Wave 3). CLONE of seed-ks-house-headshots.py, all
guards intact incl. Phase-156 hardening (dropped 'american' kw + pre-1940 historical-year reject).
Only changes: OK band, OK state name, RESULTS_JSON, and the localized ", oklahoma" place-token in
...
BANDS = {
    # OK new-candidate band (164-05 generator: actual range -400503..-400144). Upper bound is
    # -400144 (OK-1 in-century seq 44) to EXCLUDE the 43 US-Senate-cycle records occupying OK-1
    # seqs 1-43 (-400101..-400143, D-04 collision) — we never touch those. OK incumbents
    # (-40001..-40005) fall far outside this band (already imaged). Guards unchanged.
    'OK': (-400599, -400144, 'Oklahoma'),
}
...
_NON_PERSON_TITLE = _re.compile(
    r'(election|congressional district|gubernatorial|ballot|primary|\bcity\b|, oklahoma|'
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_ok-house-headshot-results.json')
