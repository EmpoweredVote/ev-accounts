"""
seed-oh-ga-nc-house-headshots.py — Phase 156 (v2.21 Wave 2) plan 156-06.
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_oh-ga-nc-house-headshot-results.json')
...
def main():
    ...
    if state not in BANDS:
        print('ERROR: --state OH|GA|NC required (or --manual <file>)'); sys.exit(1)
