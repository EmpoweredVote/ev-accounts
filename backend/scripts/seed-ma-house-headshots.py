"""
seed-ma-house-headshots.py — Phase 161-08 (v2.22 Wave 3). CLONE of seed-mi-house-headshots.py
...
Usage:
  python backend/scripts/seed-ma-house-headshots.py --state MA [--dry-run]
  python backend/scripts/seed-ma-house-headshots.py --manual <file>   (external_id|image_url|license)
Writes backend/scripts/_ma-house-headshot-results.json.
"""
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_ma-house-headshot-results.json')
...
def main():
    ...
    if state not in BANDS:
        print('ERROR: --state MA required (or --manual <file>)'); sys.exit(1)
