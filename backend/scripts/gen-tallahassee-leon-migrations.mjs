...
/**
 * ⚠ PARAMETERISED 2026-08-28, AFTER THESE MIGRATIONS HAD ALREADY APPLIED.
 *
 * This generator was copied from gen-bradenton-manatee-migrations.mjs and the
 * HEADER template below was never re-pointed, so CC_0011, CC_0012 and CC_0013
 * were all applied to prod carrying "wave FL-3", FL-3's plan path, FL-3's roster
 * path and FL-3's generator name -- and an FL-3 collision example measured at
 * Bradenton City Hall. Comment-only, but it points a reader at the wrong plan.
 * Found while writing FL-5's generator, which interpolates these constants.
 */
const WAVE = 'FL-4';
const PLAN = 'docs/superpowers/plans/2026-08-28-knight-fl-wave-4-tallahassee-leon.md';
const ROSTER_REL = 'data/seed-tallahassee-leon-2026/ROSTERS.md';
const GENERATOR = 'scripts/gen-tallahassee-leon-migrations.mjs';
