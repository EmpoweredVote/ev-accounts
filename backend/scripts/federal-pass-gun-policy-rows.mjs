...
//   for id in 119s1531is 118s25is 118hr698ih 119s3214is 118s494is; do
//     curl -so "$dir/$id.html" //       "https://www.govinfo.gov/content/pkg/BILLS-$id/html/BILLS-$id.htm"; done
//   for id in 119s1531 118s25 118hr698 119s3214 118s494; do
...
const roll = {};
for (const b of [...AWB_BILLS, ...BCE_BILLS]) {
