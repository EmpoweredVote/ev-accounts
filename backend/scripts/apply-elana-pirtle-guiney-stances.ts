...
async function main() {
  const csvPath = path.join(__dirname, '..', 'data', 'stance-research', '2026-05-30-elana-pirtle-guiney.csv');
  ...
  for (const r of rows) {
    ...
    // Write citation row — reasoning from notes, source URL extracted from notes
