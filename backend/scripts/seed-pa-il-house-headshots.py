...
BANDS = {
    'PA': (-429999, -420000, 'Pennsylvania'),
    'IL': (-179999, -170000, 'Illinois'),
}
...
RESULTS_JSON = os.path.join(os.path.dirname(__file__), '_pa-il-house-headshot-results.json')
...
def main():
    ...
    if state not in BANDS:
        print('ERROR: --state PA|IL required (or --manual <file>)'); sys.exit(1)
