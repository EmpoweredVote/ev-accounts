...
-- Municipalities 2 and 3 of 17 in Racine County, following the 1447 pattern:
...
--
-- BURLINGTON GUARD DIVERGENCE (important -- differs from 1447): Burlington elects TWO
...
--                                 AD-66 Republican candidate seeded by 1444 (-5507092).
...
--    This migration creates SEPARATE politician rows, consistent with how 1447 already handled
