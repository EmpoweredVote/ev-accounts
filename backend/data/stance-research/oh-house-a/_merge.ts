...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-18-oh-house-batch-a.csv';
...
const IN_SCOPE = new Set([-39001,-39002,-39003,-39004,-39005,-39006,-39007,-39008]);
...
function repair(raw: string): string {
  // Only collapse genuine quad+ quote artifacts (malformed). Do NOT touch triple quotes —
  // `"""text"""` is VALID RFC-4180 for a literal-quoted field ("text") adjacent to the
  // field-delimiter quotes. csv-parse with relax_quotes handles the rest.
