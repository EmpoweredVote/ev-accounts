...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-exec-w2-batch-h.csv';
...
const IN_SCOPE = new Set([-3500002,-3500004,-3500005,-3100002,-3100004,-3100005,-1600002,-1600004,-1600005]);
