...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-exec-w2-batch-f.csv';
...
const IN_SCOPE = new Set([-4000002,-4000004,-900002,-900004,-900005,-1900002,-1900004,-1900005,-3200002,-3200004,-3200005]);
