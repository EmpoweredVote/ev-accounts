...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-exec-w2-batch-i.csv';
...
const IN_SCOPE = new Set([-5400003,-5400004,-1500002,-3000002,-3000004,-4400002,-4400004,-4400005,-1000002,-1000004]);
