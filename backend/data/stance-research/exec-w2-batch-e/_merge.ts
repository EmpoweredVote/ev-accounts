...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-exec-w2-batch-e.csv';
...
const IN_SCOPE = new Set([-100002,-100004,-100005,-2200002,-2200004,-2200005,-2100002,-2100004,-2100005]);
