...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-exec-w2-batch-c.csv';
...
const IN_SCOPE = new Set([-3400002,-5300002,-5300004,-5300005,-400093,-400094,642977,688298,-2900002,-2900004,-2900005]);
