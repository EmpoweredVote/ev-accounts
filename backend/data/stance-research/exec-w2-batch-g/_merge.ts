...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-exec-w2-batch-g.csv';
...
const IN_SCOPE = new Set([-500002,-500004,-500005,-2800002,-2800004,-2800005,-2000002,-2000004,-2000005]);
