...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-gov-ag-batch-e.csv';
...
const IN_SCOPE = new Set([-2100001,-2100003,-4000001,-4000003,-900001,-900003,-500001,-500003,-2800001,-2800003]);
