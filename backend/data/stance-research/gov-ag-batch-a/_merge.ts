...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-gov-ag-batch-a.csv';
...
const IN_SCOPE = new Set([-1200001,-1200003,-3600001,-3600003,-1700001,-1700003,-4200001,-4200003,-100202,-100204]);
