...
const OUT = 'C:/EV-Accounts/backend/data/stance-research/2026-06-21-gov-ag-batch-f.csv';
...
const IN_SCOPE = new Set([-3200001,-3200003,-1900001,-1900003,-2000001,-2000003,-3500001,-3500003,-3100001,-3100003]);
