...
None — this requires platform-level resolution before beta. A user with a duplicate identity will have their gems and XP siloed with no path to merge them without manual DB intervention.

**Recommended:** Block beta launch until identity is confirmed unified across at least CTC and Validation Quests.
