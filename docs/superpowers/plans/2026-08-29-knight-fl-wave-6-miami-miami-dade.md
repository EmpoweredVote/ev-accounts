...
- [ ] **Step 1: Copy, then re-add the city half**
...
- [ ] **Step 3: Split the band guard — an absence assertion plus a positive one**
...
- [ ] **Step 5: The counts the gates assert**
...
- [ ] **Step 6: Update the test fixture and add the cases this wave introduces**
...
- [ ] **Step 7: Run the tests, generate, and grep the SQL**
